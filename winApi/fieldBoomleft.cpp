...
HRESULT fieldBoomleft::init(string objectName, OBJECTDISCERN discernNum, int mapNum, POINT pos)
{
	// ÆøÅº »óÈ£ÀÛ¿ë ¹Ú½º
	_appearMapNum = 0;
	_discernNum = sandbox;
...
void fieldBoomleft::update(POINT playerPosition, vector<bullet*> bulletPos)
{
	move();
...
void fieldBoomleft::bulletEffect()
{
