...
HRESULT mapObject01::init(string objectName, OBJECTDISCERN discernNum, int mapNum, POINT pos)
{
	// ÆøÅº »óÈ£ÀÛ¿ë ¹Ú½º
	_appearMapNum = 0;
	_discernNum = ironbox;
	...
	_image = IMAGEMANAGER->findImage("¸Ê01¿ÀºêÁ§Æ®");
...
void mapObject01::update(POINT playerPosition, vector<bullet*> bulletPos)
{
	move();
