...
HRESULT fieldBoom2_1::init(string objectName, OBJECTDISCERN discernNum, int mapNum, POINT pos)
{
	// ÆøÅº »óÈ£ÀÛ¿ë ¹Ú½º
	_appearMapNum = 0;
	_discernNum = sandbox;
...
void fieldBoom2_1::update(POINT playerPosition, vector<bullet*> bulletPos)
{
	move();
...
void fieldBoom2_1::bulletEffect()
{
